...
const VeniceArchitectureBiennale2014SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/venice-architecture-biennale-2014"}}
...
export default VeniceArchitectureBiennale2014SlideShow;
