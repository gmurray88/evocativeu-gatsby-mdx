...
const AmsterdamRijksmuseum2019SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/amsterdam-rijksmuseum-2019"}}
...
export default AmsterdamRijksmuseum2019SlideShow;
