...
const NewYorkLeslieLohman2016SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/new-york-leslie-lohman-2016"}}
...
export default NewYorkLeslieLohman2016SlideShow;
