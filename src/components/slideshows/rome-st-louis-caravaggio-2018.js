...
const RomeStLouisCaravaggio2018SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/rome-st-louis-caravaggio-2018"}}
...
export default RomeStLouisCaravaggio2018SlideShow;
