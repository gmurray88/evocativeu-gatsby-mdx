...
const AmsterdamVangoghHockney2019SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/amsterdam-vangogh-hockney-2019"}}
...
export default AmsterdamVangoghHockney2019SlideShow;
