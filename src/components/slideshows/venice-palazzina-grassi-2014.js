...
const VenicePalazzinaGrassi2014SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/venice-palazzina-grassi-2014"}}
...
export default VenicePalazzinaGrassi2014SlideShow;
