...
const FloridaKeysSnorkeling2012SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/florida-keys-snorkeling-2012"}}
...
export default FloridaKeysSnorkeling2012SlideShow;
