...
const BerlinKarlMarxAllee2011SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/berlin-karl-marx-allee-2011"}}
...
export default BerlinKarlMarxAllee2011SlideShow;
