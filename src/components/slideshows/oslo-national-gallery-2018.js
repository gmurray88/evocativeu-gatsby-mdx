...
const OsloNationalGallery2018SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/oslo-national-gallery-2018"}}
...
export default OsloNationalGallery2018SlideShow;
